...
quizRouter.post("/quiz/create", quizeController_1.createQuizRoute);
...
quizRouter.post("/quiz/showtrendingquiz", quizeController_1.showTrendingQuizzes);
quizRouter.post("/quiz/quizbyuser/:id", quizeController_1.quizCreatedBySpecificUser);
quizRouter.post("/quiz/totalCount", quizeController_1.totalCountOfQuiz_Question_Impression);
quizRouter.post("/quiz/singleQuiz/:id", quizeController_1.singleQuiz);
